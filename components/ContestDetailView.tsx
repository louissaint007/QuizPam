...
const ContestDetailView: React.FC<ContestDetailViewProps> = ({ contest, userBalance, isJoined, onBack, onJoin, onGoToMyContests, onPrizeClick }) => {
  ...
  const progress = Math.min(100, ((contest.current_participants || 0) / (contest.min_participants || 1)) * 100);
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-end">
                <div className="space-y-1">
                  ...
                  <p className="text-xs font-bold text-slate-500">{contest.current_participants || 0} moun sou {contest.min_participants} ki nesesè</p>
                </div>
          ...
          <section className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 p-8 rounded-[2.5rem] shadow-xl">
            ...
            <ul className="space-y-4">
              {[
                ...
                "Konkou a ap kòmanse lè limit nesesè a atenn."
              ].map((rule, i) => (
        ...
        <div className="space-y-6">
          <div className="bg-slate-800 border-2 border-blue-500 p-8 rounded-[3rem] shadow-2xl sticky top-24">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex justify-between items-center bg-slate-900/50 p-4 rounded-2xl border border-slate-700">
                <span className="text-[10px] font-black text-slate-500 uppercase">Okipasyon</span>
