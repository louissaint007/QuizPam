...
const JoinedContestsView: React.FC<JoinedContestsViewProps> = ({ contests, joinedIds, onBack, onEnterContest }) => {
    const joinedContests = contests.filter(c => joinedIds.includes(c.id));
